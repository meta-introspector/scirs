...
#[derive(Debug)]
pub struct UltraFusionIntelligence<F: Float + Debug + ndarray::ScalarOperand> {
...
impl<F: Float + Debug + Clone + FromPrimitive> UltraPredictiveCore<F> {
    #[allow(dead_code)]
    pub fn generate_impossible_predictions(
        &self,
        _data: &Array1<F>,
    ) -> Result<UltraPredictions<F>> {
