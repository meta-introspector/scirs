...
pub fn standard_normal_quantile(p: f64) -> f64 {
    ...
    if x.abs() > 0.7 {
        ...
        if w < 5.0 {
            ...
            let w = w.sqrt();
            let z = 6.65790464350110377;
            let z = z * w + 5.46378491116411436;
            let z = z * w + 1.78482653991729133;
            let z = z * w + 0.296560571828504891;
            let z = z * w + 0.0265321895265761230;
            let z = z * w + 0.00124266094738807843;
            let z = z * w + 0.0000271155556874348757;
            let z = z * w + 0.0000020103343992922881;
