...
#[allow(dead_code)]
pub fn safe_f64_to_float<T: Float + FromPrimitive>(_value: f64) -> NdimageResult<T> {
...
#[allow(dead_code)]
pub fn safe_float_to_f64<T: Float>(_value: T) -> NdimageResult<f64> {
    _value
        .to_f64()
...
#[allow(dead_code)]
pub fn safe_usize_to_float<T: Float + FromPrimitive>(_value: usize) -> NdimageResult<T> {
...
#[allow(dead_code)]
pub fn safe_float_to_usize<T: Float>(_value: T) -> NdimageResult<usize> {
