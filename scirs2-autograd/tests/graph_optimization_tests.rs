...
mod optimization_tests {
    ...
    fn test_public_optimization_api() {
        ...
        let _level_result = optimization::optimize_graph_with_level(
            dummy_graph, 
...
mod integration_tests {
    ...
    fn test_pattern_matching_and_simplification() {
        use scirs2_autograd::optimization::{
            ...
            expression_simplification::{is_commutative, is_associative, has_identity, get_identity},
        };
    ...
    fn test_memory_analysis_and_lifetime() {
        use scirs2_autograd::optimization::memory_optimization::{
            MemoryAnalysis, TensorLifetime, TensorLifetimeAnalyzer, MemoryPoolManager,
        };
    ...
    fn test_fusion_patterns_and_graph_rewriting() {
        use scirs2_autograd::optimization::graph_rewriting::{
            FusionPattern, FusionType, FusionConstraint, GraphRewriter,
            can_fuse_operations, estimate_fusion_benefit,
        };
    ...
    fn test_comprehensive_optimization_pipeline() {
        ...
        let memory_optimizer = MemoryOptimizer::<f32>::with_config(
        ...
        let visualizer = GraphVisualizer::<f32>::with_config(
            VisualizationConfig {
                show_shapes: true,
                show_operations: true,
                show_gradients: true,
...
mod ultrathink_feature_integration_tests {
    ...
    fn test_efficient_operations_integration() {
        ag::run(|ctx: &mut ag::Context<f32>| {
            ...
            let slices = vec![
                T::SliceRange::new(Some(0), Some(50), Some(1)),
            ];
