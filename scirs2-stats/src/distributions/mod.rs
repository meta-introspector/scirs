...
where
    F: num_traits: Float + num, num_traits::NumCast,
{
...
where
    F: num_traits: Float + num, num_traits::NumCast + std::marker::Send + std::marker::Sync,
{
...
where
    T: num_traits: Float + num, num_traits::NumCast,
{
...
where
    F: num_traits: Float + num, num_traits::NumCast + std::fmt::Debug,
{
...
/// ```
#[allow(dead_code)]
pub fn weibull_min<F>(_shape: F, scale: F, loc: F) -> StatsResult<Weibull<F>>
where
    F: num_traits: Float + num, num_traits::NumCast,
{
    weibull(_shape, scale, loc)
}
...
where
    F: num_traits: Float + num, num_traits::NumCast + std::fmt::Display,
{
    Bernoulli::new(p)
}
...
where
    F: num_traits: Float + num, num_traits::NumCast + num_traits::FloatConst,
{
