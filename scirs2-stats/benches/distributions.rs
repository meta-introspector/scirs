...
use scirs2_stats::distributions::{
    norm, uniform, t, chi2, f, gamma, beta, expon, poisson, binom,
    Normal, Uniform, StudentT, ChiSquare, F, Gamma, Beta, Exponential, Poisson, Binomial,
};
use ndarray::Array1;
