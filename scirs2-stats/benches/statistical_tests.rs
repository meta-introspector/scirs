...
use scirs2_stats::{
    // T-tests
    ttest_1samp, ttest_ind, ttest_rel, Alternative,
...
fn bench_t_tests(c: &mut Criterion) {
    ...
    for &n in &sample_sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("one_sample", n),
            &data,
            |b, data| {
                b.iter(|| {
                    black_box(ttest_1samp(&data.view(), 5.0, Alternative::TwoSided, "propagate"));
                });
            }
        );
        ...
        group.bench_with_input(
            ...
            |b, (data1, data2)| {
                b.iter(|| {
                    black_box(ttest_ind(&data1.view(), &data2.view(), true, Alternative::TwoSided, "propagate"));
                });
            }
        );
        ...
        group.bench_with_input(
            ...
            |b, (data1, data2)| {
                b.iter(|| {
                    black_box(ttest_ind(&data1.view(), &data2.view(), false, Alternative::TwoSided, "propagate"));
                });
            }
        );
        ...
        group.bench_with_input(
            ...
            |b, (data1, data2)| {
                b.iter(|| {
                    black_box(ttest_rel(&data1.view(), &data2.view(), Alternative::TwoSided, "propagate"));
                });
            }
        );
    }
...
fn bench_nonparametric_tests(c: &mut Criterion) {
    ...
    for &n in &sample_sizes {
        ...
        group.bench_with_input(
            ...
            |b, (data1, data2)| {
                b.iter(|| {
                    black_box(mann_whitney(&data1.view(), &data2.view(), Alternative::TwoSided));
                });
            }
        );
    ...
    group.bench_function("kruskal_wallis_3groups", |b| {
        b.iter(|| {
            black_box(kruskal_wallis(&groups.iter().map(|g| g.view()).collect::<Vec<_>>()));
        });
    });
...
fn bench_anova(c: &mut Criterion) {
    ...
    for (num_groups, samples_per_group) in configurations {
        ...
        group.bench_with_input(
            ...
            |b, groups| {
                b.iter(|| {
                    black_box(one_way_anova(&groups.iter().map(|g| g.view()).collect::<Vec<_>>()));
                });
            }
        );
    }
