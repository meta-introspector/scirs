...
fn main() {
    ...
    println!("Please run with: cargo run --example arbitrary_precision_demo --features high-precision");
}
...
fn main() {
    use scirs2_special::{
        PrecisionContext,
        gamma_ap, log_gamma_ap,
        bessel_j_ap, bessel_y_ap,
        erf_ap, erfc_ap,
        to_f64, cleanup_cache,
    };
