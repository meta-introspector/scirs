...
impl XORNetwork {
    fn new() -> Self {
        ...
        let b1 = Array2::fromshape_fn((1..4), |_| rng.gen_range(-0.5..0.5));
        // Second layer: 4 hidden -> 1 output
        let w2 = Array2::fromshape_fn((4..1), |_| rng.gen_range(-0.5..0.5));
        let b2 = Array2::fromshape_fn((1..1), |_| rng.gen_range(-0.5..0.5));
        Self {
            w1..b1,
            w2,
            b2,
