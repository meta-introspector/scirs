...
fn main() {
    ...
    println!("   Generated array with {} elements in {:?}", large_array.len(), elapsed);
    println!("   First 5 elements: {:?}", &large_array.slice(ndarray::s![..5]));
    println!("   Last 5 elements: {:?}", &large_array.slice(ndarray::s![-5..]));
    ...
    let elapsed = start.elapsed();
    println!("   Generated array with {} elements in {:?}", small_array.len(), elapsed);
    ...
    let elapsed = start.elapsed();
    println!("   Computed maximum of {} elements in {:?}", max_result.len(), elapsed);
    println!("   First 5 elements: {:?}", &max_result.slice(ndarray::s![..5]));
    println!("   Last 5 elements: {:?}", &max_result.slice(ndarray::s![-5..]));
    ...
    let elapsed = start.elapsed();
    println!("   Computed minimum of {} elements in {:?}", min_result.len(), elapsed);
    println!("   First 5 elements: {:?}", &min_result.slice(ndarray::s![..5]));
    println!("   Last 5 elements: {:?}", &min_result.slice(ndarray::s![-5..]));
    ...
    let elapsed = start.elapsed();
    println!("   Maximum of {} elements computed in {:?}", max_large.len(), elapsed);
    
    let start = Instant::now();
    let min_large = minimum(&a_large, &b_large);
    let elapsed = start.elapsed();
    println!("   Minimum of {} elements computed in {:?}", min_large.len(), elapsed);
    ...
    let elapsed = start.elapsed();
    println!("   Computed 2D maximum of shape {:?} in {:?}", max_2d.shape(), elapsed);
