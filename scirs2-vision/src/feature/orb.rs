...
fn generate_brief_pattern() -> Vec<(i32, i32, i32, i32)> {
    ...
    for _ in 0..256 {
        let x1 = rng.random_range(-max_offset..=max_offset);
        let y1 = rng.random_range(-max_offset..=max_offset);
        let x2 = rng.random_range(-max_offset..=max_offset);
        let y2 = rng.random_range(-max_offset..=max_offset);
