...
use scirs2_cluster::vq::{
    kmeans_with_metric, EuclideanDistance, ManhattanDistance, ChebyshevDistance, 
    CosineDistance, CorrelationDistance, MahalanobisDistance,
    KMeansOptions, KMeansInit
};
...
fn demo_euclidean_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Euclidean K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
...
fn demo_manhattan_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Manhattan K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
...
fn demo_chebyshev_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Chebyshev K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
...
fn demo_cosine_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Cosine K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
...
fn demo_correlation_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Correlation K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
...
fn demo_mahalanobis_distance(data: &Array2<f64>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Mahalanobis K-means: Silhouette = {:.3}, Time = {:?}", silhouette, duration);
