...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    visualizer.export_visualization(&visualization_output, "ultrathink_clustering_full")?;

    // Create a quick visualization report
    create_ultrathink_visualization_report(&data.view(), &result, "ultrathink_clustering_report")?;
...
fn demonstrate_visualization_configurations(
    ...
    let quantum_config = UltrathinkVisualizationConfig {
        show_quantum_coherence: true,
    ...
    let quantum_vis = visualize_ultrathink_results(&data.view(), result, Some(quantum_config))?;
    ...
    let neuro_config = UltrathinkVisualizationConfig {
    ...
    let neuro_vis = visualize_ultrathink_results(&data.view(), result, Some(neuro_config))?;
    ...
    let ai_config = UltrathinkVisualizationConfig {
        show_quantum_coherence: false,
        show_neuromorphic_adaptation: false,
        show_ai_selection: true,
        quantum_color_scheme: QuantumColorScheme::QuantumRainbow,
    ...
    let ai_vis = visualize_ultrathink_results(&data.view(), result, Some(ai_config))?;
    ...
    let custom_config = UltrathinkVisualizationConfig {
        show_quantum_coherence: true,
        show_neuromorphic_adaptation: true,
        show_ai_selection: true,
    ...
    let custom_vis = visualize_ultrathink_results(&data.view(), result, Some(custom_config))?;
