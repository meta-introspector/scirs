...
fn generate_clustered_data(n_samples: usize, n_features: usize, n_clusters: usize, noise: f64) -> Array2<f64> {
    ...
    for &n_samples in &sizes {
        ...
        for method in methods {
            group.bench_with_input(
                ...
                |b, data| {
                    b.iter(|| {
                        linkage(data.view(), method, Metric::Euclidean)
                    })
                },
            );
        }
...
fn bench_spectral(c: &mut Criterion) {
    ...
    for &n_samples in &sizes {
        ...
        group.bench_with_input(
            ...
            |b, data| {
                b.iter(|| {
                    spectral_clustering(data.view(), k, Some(options.clone()))
                })
            },
        );
    }
    ...
    for &n_samples in &sizes {
        ...
        for metric in metrics {
            group.bench_with_input(
                ...
                |b, data| {
                    b.iter(|| {
                        linkage(data.view(), LinkageMethod::Single, metric)
                    })
                },
            );
        }
...
fn bench_validation_metrics(c: &mut Criterion) {
    ...
    for &n_samples in &sizes {
        ...
        group.bench_with_input(
            ...
            |b, linkage| {
                b.iter(|| {
                    validate_linkage_matrix(linkage.view(), n_samples)
                })
            },
        );
    }
...
fn bench_data_structures(c: &mut Criterion) {
    use scirs2_cluster::hierarchy::{DisjointSet, condensed_to_square, square_to_condensed};
    ...
    for &n_points in &[10, 20, 50, 100] {
        ...
        group.bench_with_input(
            ...
            |b, condensed| {
                b.iter(|| {
                    condensed_to_square(condensed.view())
                })
            },
        );
        ...
        group.bench_with_input(
            ...
            |b, square| {
                b.iter(|| {
                    square_to_condensed(square.view())
                })
            },
        );
    }
