...
use crate::optimizers::{SGD, Optimizer};
        ...
        #[cfg(feature = "gpu")]
        {
            ...
            if self.cpu_optimizer.momentum != A::zero() {
                ...
                if std::any::TypeId::of::<A>() == std::any::TypeId::of::<f32>() {
                    ...
                    kernel.set_f32("momentum_factor", self.cpu_optimizer.momentum.to_f32().unwrap());
                    ...
                    kernel.set_f64("momentum_factor", self.cpu_optimizer.momentum.to_f64().unwrap());
