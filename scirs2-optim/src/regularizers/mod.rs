...
pub use elastic__net::ElasticNet;
pub use entropy::{EntropyRegularization, EntropyRegularizerType};
pub use l1::L1;
pub use l2::L2;
pub use label__smoothing::LabelSmoothing;
...
pub use spatial__dropout::{FeatureDropout, SpatialDropout};
pub use spectral__norm::SpectralNorm;
pub use stochastic__depth::StochasticDepth;
pub use weight__standardization::WeightStandardization;
