    ...
    fn test_computer_vision_optimization() {
        ...
        let context = OptimizationContext {
            ...
            training_config: TrainingConfiguration {
                ...
                lr_schedule_type: LearningRateScheduleType::CosineAnnealing { t, max: 100 },
    ...
    fn test_natural_language_optimization() {
        ...
        let context = OptimizationContext {
            ...
            training_config: TrainingConfiguration {
                ...
                validation_frequency: 1,
                lr_schedule_type: LearningRateScheduleType::OneCycle { max, lr: 2e-5 },
                regularization_approach: RegularizationApproach::Dropout { dropout, rate: 0.1 },
            },
            domain_metadata: HashMap::new(),
        };
