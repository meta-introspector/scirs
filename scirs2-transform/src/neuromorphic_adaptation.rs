...
impl SpikingNeuron {
    ...
    pub fn apply_stdp(&mut self, pre_spike_times: &[f64], post_spike_time: Option<f64>) {
...
impl AdvancedNeuromorphicProcessor {
    ...
    fn advanced_network_simulation(&mut self, input_pattern: &Array1<f64>) -> Result<Array1<f64>> {
