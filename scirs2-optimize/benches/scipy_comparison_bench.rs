...
fn get_benchmark_problems() -> Vec<BenchmarkConfig> {
    vec![
        BenchmarkConfig {
            name: "Rosenbrock",
            function: test,functions: rosenbrock,
        ...
        BenchmarkConfig {
            name: "Sphere",
            function: test,functions: sphere,
        ...
        BenchmarkConfig {
            name: "Rastrigin",
            function: test,functions: rastrigin,
        ...
        BenchmarkConfig {
            name: "Ackley",
            function: test,functions: ackley,
        ...
        BenchmarkConfig {
            name: "Himmelblau",
            function: test,functions: himmelblau,
...
fn bench_least_squares(c: &mut Criterion) {
    ...
    for &n in &n_points {
        ...
        let y_data: Vec<f64> = x_data
            .iter()
            .map(|&x| 2.0 + 3.0 * x + 0.1 * rand::rng().gen::<f64>())
            .collect();
